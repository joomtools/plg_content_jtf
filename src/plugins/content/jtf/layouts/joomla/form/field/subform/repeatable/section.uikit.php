		...
		<div class="uk-margin-top uk-width-1-1 uk-text-right">
			<div class="uk-button-group">
				<?php if (!empty($buttons['add'])) : ?><a
					class="group-add uk-button uk-button-small uk-button-success group-add-<?php echo $unique_subform_id; ?>"
					aria-label="<?php echo JText::_('JGLOBAL_FIELD_ADD'); ?>"><span class="uk-icon-plus"></span>
					</a><?php endif; ?>
				<?php if (!empty($buttons['remove'])) : ?><a
					...
					aria-label="<?php echo JText::_('JGLOBAL_FIELD_REMOVE'); ?>"><span class="uk-icon-minus"></span>
					</a><?php endif; ?>
				<?php if (!empty($buttons['move'])) : ?><a
					...
					aria-label="<?php echo JText::_('JGLOBAL_FIELD_MOVE'); ?>"><span class="uk-icon-move"></span>
					</a><?php endif; ?>
			</div>
		</div>
	<?php endif; ?>
