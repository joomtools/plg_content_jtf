...
use Joomla\CMS\Form\Field\SubformField as JoomlaSubformField;
 ...
 *        layout="joomla.form.field.subform.repeatable-table" groupByFieldset="false" component="com_example"
 *        client="site" label="Field Label" description="Field Description" />
 *
 * @since   4.0.0
 */
class SubformField extends JoomlaSubformField
{
