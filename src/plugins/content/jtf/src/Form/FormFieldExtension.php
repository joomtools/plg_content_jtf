    ...
    protected function getOptions()
    {
        ...
        foreach ($this->element->xpath('option') as $optionKey => $option) {
            ...
            $optionClass = ArrayHelper::arrayUnique(
                array_merge($globalOptonClass, $optionClass));
            ...
            $optionLabelClass = ArrayHelper::arrayUnique(
                array_merge($globalOptonLabelClass, $optionLabelClass)
            );
    ...
    public function validate($value = null, $group = null, ?Registry $input = null)
    {
        ...
        if (!($this->element instanceof \SimpleXMLElement)) {
            throw new \UnexpectedValueException(
                sprintf('%s::validate `element` is not an instance of SimpleXMLElement', \get_class($this))
            );
        }
