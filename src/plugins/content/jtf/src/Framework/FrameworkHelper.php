...
class FrameworkHelper
{
    ...
    private function setFieldClass(FormField $field)
    {
        ...
        foreach ($this->fieldAttributes as $attribute) {
            ...
            if (!empty($frwkAttributeClasses = $frwk->getClasses($attribute))) {
                $frwkAttributeClasses = $this->getClassArray($frwkAttributeClasses);

                if (!isset($classes['frwk'][$attribute])) {
                    $classes['frwk'][$attribute] = [];
                }

                $classes['frwk'][$attribute] = array_merge_recursive(
                    $classes['frwk'][$attribute],
                    $frwkAttributeClasses
                );
            }
        }
        ...
        !empty($classes['frwk']['gridgroup'])
            ? $this->gridGroup['default'] = array_merge(
        ...
        if (empty($classes['field']['descriptionclass']) && !empty($classes['frwk']['descriptionclass'])) {
            $form->setFieldAttribute($fieldName, 'descriptionclass', implode(' ', $classes['frwk']['descriptionclass']));
        }
