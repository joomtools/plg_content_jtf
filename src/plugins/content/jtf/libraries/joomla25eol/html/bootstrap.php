...
abstract class JHtmlBootstrap
{
	...
	public static function framework($debug = null)
	{
		...
		JHtml::_('script', 'plugins/content/jtf/assets/js/jui/bootstrap.min.js', array('version' => 'auto', 'detectDebug' => $debug));
	...
	public static function tooltipExtended($extended = true)
	{
		if ($extended)
		{
			JHtml::_('script', 'plugins/content/jtf/assets/js/jui/bootstrap-tooltip-extended.min.js', array('version' => 'auto'));
			JHtml::_('stylesheet', 'plugins/content/jtf/assets/css/bootstrap-tooltip-extended.css', array('version' => 'auto'));
		}
	}
	...
	public static function startAccordion($selector = 'myAccordian', $params = array())
	{
		if (!isset(self::$loaded[__METHOD__][$selector]))
		{
			...
			$parents = array_key_exists(__METHOD__, self::$loaded) ? array_filter(array_column(self::$loaded[__METHOD__], 'parent')) : array();
			...
			// Set static array
			self::$loaded[__METHOD__][$selector] = $opt;
	...
	{
		$in = (self::$loaded[__CLASS__ . '::startAccordion'][$selector]['active'] == $id) ? ' in' : '';
		$collapsed = (self::$loaded[__CLASS__ . '::startAccordion'][$selector]['active'] == $id) ? '' : ' collapsed';
		$parent = self::$loaded[__CLASS__ . '::startAccordion'][$selector]['parent'] ?
			' data-parent="' . self::$loaded[__CLASS__ . '::startAccordion'][$selector]['parent'] . '"' : '';
	...
	public static function loadCss($includeMainCss = true, $direction = 'ltr', $attribs = array())
	{
		...
		if ($includeMainCss)
		{
			JHtml::_('stylesheet', 'plugins/content/jtf/assets/css/bootstrap.min.css', array('version' => 'auto'), $attribs);
			JHtml::_('stylesheet', 'plugins/content/jtf/assets/css/bootstrap-responsive.min.css', array('version' => 'auto'), $attribs);
			JHtml::_('stylesheet', 'plugins/content/jtf/assets/css/bootstrap-extended.css', array('version' => 'auto'), $attribs);
		}

		// Load Bootstrap RTL CSS
		if ($direction === 'rtl')
		{
			JHtml::_('stylesheet', 'plugins/content/jtf/assets/css/bootstrap-rtl.css', array('version' => 'auto'), $attribs);
		}
	}
}
