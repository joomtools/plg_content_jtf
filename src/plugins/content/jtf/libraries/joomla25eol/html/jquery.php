...
//		JHtml::_('script', 'jui/jquery.min.js', array('version' => 'auto', 'relative' => true, 'detectDebug' => $debug));
		JHtml::_('script', 'plugins/content/jtf/assets/js/jui/jquery.min.js', array('version' => 'auto', 'detectDebug' => $debug));

		// Check if we are loading in noConflict
		if ($noConflict)
		{
//			JHtml::_('script', 'jui/jquery-noconflict.js', array('version' => 'auto', 'relative' => true));
			JHtml::_('script', 'plugins/content/jtf/assets/js/jui/jquery-noconflict.js', array('version' => 'auto'));
		}
...
//			JHtml::_('script', 'jui/jquery-migrate.min.js', array('version' => 'auto', 'relative' => true, 'detectDebug' => $debug));
			JHtml::_('script', 'plugins/content/jtf/assets/js/jui/jquery-migrate.min.js', array('version' => 'auto', 'detectDebug' => $debug));
		}
