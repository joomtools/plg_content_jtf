...
class JForm
{
	...
	protected function filterField($element, $value)
	{
		...
		switch (strtoupper($filter))
		{
			...
			case 'INT_ARRAY':
				...
				$value = JArrayHelper::toInteger($value);
				$return = $value;
				break;
	 ...
	 * @param   boolean  $new   Flag to toggle whether we should get a new instance of the object.
	 *
	 * @return  JFormRule|boolean  FormRule object on success, false otherwise.
	 *
	...
	protected function syncPaths()
	{
		...
		{
			JFormHelper::addFieldPrefix($prefix);
		}
		...
		foreach ($prefixes as $prefix)
		{
			JFormHelper::addFormPrefix($prefix);
		}
		...
		foreach ($prefixes as $prefix)
		{
			JFormHelper::addRulePrefix($prefix);
		}
