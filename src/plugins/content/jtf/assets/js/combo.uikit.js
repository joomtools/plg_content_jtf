	...
	var combobox = function (options, elem) {
		var self = {},
			init = function (options, elem) {
				...
				self.$dropDown = self.$dropBtnDiv.find('ul.uk-nav-dropdown').parent();
			...
			render = function () {
				...
				var inputWidth = self.$input.width(),
					btnWidth = self.$dropBtn.width(),
					totalWidth = inputWidth - 3,
					dropDownLeft = -inputWidth + btnWidth - 10,
